...
public class MediaPlaybackService extends Service {
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.juny.junymusic.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "com.juny.junymusic.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "com.juny.junymusic.musicservicecommand.previous";
    public static final String NEXT_ACTION = "com.juny.junymusic.musicservicecommand.next";
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        mMediaMountedCount++;
                        mCardId = Utils.getCardId(MediaPlaybackService.this);
                        reloadQueue();
...
//            ed.apply();
    ...
    private void updateNotification() {
        ...
        views.setImageViewResource(R.id.icon, R.drawable.btn_songs_off_default);
        if (getAudioId() < 0) {
            // streaming
        ...
        status.icon = R.drawable.btn_songs_off_default;
        status.contentIntent = PendingIntent.getActivity(this, 0,
                new Intent("com.juny.junymusic.PLAYBACK_VIEWER")
